<x-app-layout>
    <div class="p-6 bg-white shadow rounded-lg">
        ...
        <form method="POST" action="{{ route('admin.books.store') }}" enctype="multipart/form-data" class="space-y-4">
            ...
            <!-- Penulis -->
            <div>
                <x-input-label for="author" :value="__('Penulis')" class="text-green-700" />
                <x-text-input id="author" name="author" type="text" :value="old('author')" required
                    class="block w-full border border-green-300 rounded-md shadow-sm text-gray-900
                    focus:border-green-500 focus:ring focus:ring-green-200 hover:border-green-400" />
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="5"
                    class="block w-full border border-green-300 rounded-md shadow-sm text-gray-900
                    focus:border-green-500 focus:ring focus:ring-green-200 hover:border-green-400">{{ old('description') }}</textarea>
            ...
            <div>
                ...
                <input id="cover_path" name="cover_path" type="file" required
                ...
                <p class="mt-1 text-sm text-gray-700">File: JPG, PNG, WEBP (Maks 2MB).</p>
